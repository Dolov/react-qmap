...
var ReactQMap = function (_Component) {
    ...
    function ReactQMap() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactQMap.__proto__ || Object.getPrototypeOf(ReactQMap)).call.apply(_ref, [this].concat(args))), _this), _this._addScript = function () {
            ...
            var icon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'https://3gimg.qq.com/lightmap/components/locationPicker2/image/marker.png';
    ...
    _createClass(ReactQMap, [{
        ...
        value: function componentDidMount() {
            if (!QMap || !QMap.LatLng) this._addScript();else checkCenter(this.props.center) && this._initMap(this.props); // center存在时执行初始化
        }
    }, {
